<nav x-data="{ open: false }" class="bg-brand border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex no-print">
                    ...
                    <x-nav-link :href="route('public.diaries.index')" :active="request()->routeIs('public.diaries.index')">
                        {{ __('みんなの日記') }}
                    </x-nav-link>
            ...
            <div class="flex items-center">
                ...
                {{-- Hamburger --}}
                <div class="-me-2 flex items-center sm:hidden no-print">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden no-print">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('public.diaries.index')" :active="request()->routeIs('public.diaries.index')">
                {{ __('みんなの日記') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 no-print">
            <div class="px-4">
