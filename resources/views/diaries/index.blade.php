<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 motion-safe:animate-fade-up">
            ...
            <article x-data @click="window.location='{{ route('diaries.show', $diary) }}'" class="bg-slate-50 dark:text-gray-800 border border-gray-600 dark:border-gray-200 rounded-2xl shadow-md overflow-hidden transform transition-transform duration-200 hover:scale-105 hover:shadow-xl">
