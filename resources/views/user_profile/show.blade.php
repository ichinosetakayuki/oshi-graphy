<x-app-layout>
    ...
    <div class="max-w-5xl w-full mx-auto px-4 py-4 sm:py-6">
        <div class="max-w-3xl mx-auto border rounded-2xl px-4 sm:px-8 py-6 shadow bg-white space-y-4 motion-safe:animate-fade-up">
            ...
            <div class="flex justify-end">
                <a x-data @click="history.back()" class="underline text-gray-600 text-xs sm:text-base cursor-pointer">戻る</a>
            </div>
        </div>
    </div>
